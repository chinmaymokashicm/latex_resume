...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Graduate Researcher - Imaging Informatics}{May 2022 -  May 2023}
    \resumeItemListStart
        % \noindent%
        % \begin{tabularx}{\textwidth}{p{.4\textwidth}X}
        %     \textbf{Tasks} & \textbf{Projects} \\
        %     % \tabitem Implemented nnU-Net pipelines on annotated 3D MRI sequences and CT images & Building an automatic deep learning tool to screen patients for endometriosis
        %     Implemented nnU-Net pipelines on annotated 3D MRI sequences and CT images & Building an automatic deep learning tool to screen patients for endometriosis
        % \end{tabularx}
        ...
        \resumeItemNested{Tasks}{
            \begin{itemize}
                ...
                \item Performed text processing on radiology reports
                % \item Analyzed deep learning outcomes created reports
                \end{itemize}
        }
      \resumeItemListEnd
    ...
    \resumeSubheading
    {School of Biomedical Informatics, UTHealth}{Houston, TX}
    {Graduate Researcher - Social Media}{May 2021 -  September 2021}
    \resumeItemListStart
        \resumeItemNested{Project}{
            \begin{itemize}
