  ...
  \resumeSubHeadingListStart
    ...
    \begin{itemize}
        \item To assess the diagnostic characteristics of the Epic Sepsis Predictive Model (ESPM)\\
            \textit{
            Writing \textbf{complex SQL queries} on Oracle databases containing Epic EHR data of 3+ million patients to derive computations and generate information to be used to analysis.
